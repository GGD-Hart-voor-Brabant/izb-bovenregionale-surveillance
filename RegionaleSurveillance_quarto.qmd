...
format:
  docx:
    reference_doc: Styling_template.docx
    toc: true
...
pad_naar_Osiris_bestand <- "input/Cijfers Osiris - kwartaal.xlsx"
...
plot_kinkhoest1 <- plot_incidentie(data = ziekten_incl_regio_per_maandJaar, kolom = "Meldingsplichtige.ziekte", ziekte = "Kinkhoest (Pertussis)")
plot_kinkhoest2 <- plot_incidentie(data = ziekten_incl_regio_per_maandJaar %>%
                                    filter(Jaar %in% c(2023,2024)), kolom = "Meldingsplichtige.ziekte", ziekte = "Kinkhoest (Pertussis)") 
...
plot_telefoon_mazelen <- plot_incidentie(data = telefoon_incl_regio_per_maandJaar %>%
                                    filter(Jaar %in% c(2023,2024)), kolom = "Specific.Topic", ziekte = "Mazelen") 
...
# Regionale surveillance ZeeBraLim kwartaaloverzicht van Q1 2024
Datum export gegevens meldingsplichtige ziekten: 26-04-2024
...
```{r 1meldplichtZiekten_kinkhoest1_plot, dpi=600}
plot_kinkhoest1
...
## Kinkhoest per 1 miljoen inwoners in 2023 en 2024

```{r 1meldplichtZiekten_kinkhoest2_plot, dpi=600}
plot_kinkhoest2
...
## Art 26 meldingen 1e kwartaal 2024; aantal en incidentie per scenario
...
## Art 26 meldingen 1e kwartaal 2024; aantal en incidentie per Principal Contextual Setting
...
```{r telefoon_scabies, dpi=600}
plot_telefoon_scabies

```

## Incidentie telefonische vragen over mazelen per 1 miljoen inwoners

```{r telefoon_mazelen, dpi=600}
plot_telefoon_mazelen
